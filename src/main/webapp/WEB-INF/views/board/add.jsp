...
<div class="main">
    <form id="frm-board-add" action="/dokky/add-form" method="POST" class="my-3">
        ...
        <input type="text" name="boardTitle" id="boardTitle" class="form-control"  style="white-space: pre-line;" />
        <!-- 내용 -->              
        <div class="mb-3">
            <label for="content" class="form-label mt-2">내용</label>
            <textarea type="text" name="boardContent" id="boardContent" class="form-control"></textarea>
        </div>
